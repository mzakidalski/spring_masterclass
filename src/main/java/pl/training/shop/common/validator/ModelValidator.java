...
public class ModelValidator {
    ...
    private void validate(MethodSignature methodSignature, Object argument, int argumentIndex) {
        ...
        Optional<Validate> validateAnnotations = getValidateAnnotation(annotations);
        validateAnnotations.ifPresent(validate -> validatorService.validate(argument, validate.exception()));
    }
